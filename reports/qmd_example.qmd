...
![](../results/horse_pops_plot.png){width=95%}

Horse populations for all provinces in Canada from 1906 - 1972.
:::
 

We can see from @fig-horses-pop that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-horses_sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horses-pop.

::: {#fig-horses-pop-sd}

![](../results/horse_pop_plot_largest_sd.png){width=70%}

Horse populations for the province with the largest standard deviation
:::


In @fig-horses-pop-sd we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
